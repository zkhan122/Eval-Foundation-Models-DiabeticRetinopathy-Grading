...
from utilities.utils import identity_transform, show_images, test_clip, weighted_class_imbalance, calculate_metrics
...
# changing classification head size
num_classes = 5
...
test_loss, test_acc, precision, recall, f1, quadratic_weighted_kappa = test_clip(
...
results_path = "results/clip_test_results.json"
