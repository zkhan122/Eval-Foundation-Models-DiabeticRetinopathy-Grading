...
from utilities.utils import show_images
...
if __name__ == "__main__":
    ...
    train_dataset = CombinedDRDataSet(root_directories=root_directories, split="train", img_transform=train_transformations, label_transform=lambda x: x)
    ...
    show_images(train_dataset, train_labels, num_images=8)
