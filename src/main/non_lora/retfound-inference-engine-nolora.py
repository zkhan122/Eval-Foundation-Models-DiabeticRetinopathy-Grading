...
def main():
    ...
    with open("../best_models/retfound-nonlora-benchmark.json", "w") as f:
        json.dump(benchmark, f, indent=4)

    plot_all_benchmark(
        source     = benchmark,
        output_dir = "../../plots/nonlora-final-plots/retfound-nonlora-benchmark",
        skip       = 1,
        model_name = "RETFound Non-LoRA",
    )
