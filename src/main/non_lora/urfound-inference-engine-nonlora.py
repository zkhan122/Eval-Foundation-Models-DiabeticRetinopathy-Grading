...
def main():
    ...
    with open("../best_models/urfound-nonlora-benchmark.json", "w") as f:
        json.dump(benchmark, f, indent=4)

    plot_all_benchmark(
        source     = benchmark,
        output_dir = "../../plots/nonlora-final-plots/urfound-nonlora-benchmark-plots",
        skip       = 1,
        model_name = "URFound Non-LoRA",
    )
